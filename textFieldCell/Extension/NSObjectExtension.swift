 ...
 */
func ZNLog<T>(message:T, file: NSString = #file, method: String = #function, line: Int = #line) {
...
//        let delayTime = dispatch_time(DispatchTime.now().rawValue, Int64(delay64 * nano64))
//        
//        dispatch_after(delayTime, DispatchQueue.main, block)
//    }
...
func getUUID() -> String {
    ...
    //替换字符串
    let resultStr = result.replacingOccurrences(of: "-", with: "")
    return resultStr.replacingOccurrences(of:" ", with: "")
}
