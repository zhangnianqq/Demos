...
extension UITextField {
    ...
    class func createTextField(frame:CGRect, leftImageName:String?, rightImageName:String?, placheholder:String?, font:CGFloat, isPassWord:Bool, borderStyle:UITextBorderStyle?, keyboardType:UIKeyboardType?)->UITextField {
        ...
        textfield.configTextField(leftText: nil, leftTextColor: nil, rightText: nil, rightTextColor: nil,leftImageName:leftImageName, rightImageName: rightImageName, leftView: nil, rightView: nil, font: font, placheholder: placheholder, isPassWord: isPassWord, borderStyle: borderStyle, keyboardType: keyboardType)
    ...
    class func createTextFieldCustomView(frame:CGRect, leftView:UIView?, rightView:UIView?, placheholder:String?, font:CGFloat, isPassWord:Bool, borderStyle:UITextBorderStyle?, keyboardType:UIKeyboardType?)->UITextField {
        let textfield = UITextField(frame: frame)
        textfield.configTextField(leftText: nil, leftTextColor: nil, rightText: nil, rightTextColor: nil, leftImageName: nil, rightImageName: nil, leftView: leftView, rightView: rightView, font: font, placheholder: placheholder, isPassWord: isPassWord, borderStyle: borderStyle, keyboardType: keyboardType)
        return textfield
    }
    ...
    class func createTextFieldunderLine(frame:CGRect, leftImageName:String?, rightImageName:String?, placheholder:String, font:CGFloat, isPassWord:Bool, keyboardType:UIKeyboardType?)->UITextField {
        let textfield = UITextField(frame: frame)
        textfield.configTextField(leftText: nil, leftTextColor: nil, rightText: nil, rightTextColor: nil,leftImageName:leftImageName, rightImageName: rightImageName, leftView: nil, rightView: nil, font: font, placheholder: placheholder, isPassWord: isPassWord, borderStyle: nil, keyboardType: keyboardType)
        //下划线
//        let line = ZNLineView(frame: CGRect(0, frame.height-2, frame.width, 2))
...
//        textfield.addSubview(line)
    ...
    class func createLabelTextField(frame:CGRect, leftText:String?,leftTextColor:UIColor?,rightText:String?,rightTextColor:UIColor?, placheholder:String?, font:CGFloat, isPassWord:Bool, borderStyle:UITextBorderStyle?, keyboardType:UIKeyboardType? )->UITextField {
        let textfield = UITextField(frame: frame)
        textfield.configTextField(leftText: leftText, leftTextColor: leftTextColor, rightText: rightText, rightTextColor: rightTextColor,leftImageName:nil, rightImageName: nil, leftView: nil, rightView: nil, font: font, placheholder: placheholder, isPassWord: isPassWord, borderStyle: borderStyle, keyboardType: keyboardType)
        return textfield
    }
    ...
    func configTextField(leftText:String?, leftTextColor:UIColor?, rightText:String?,rightTextColor:UIColor?, leftImageName:String?, rightImageName:String?, leftView:UIView?, rightView:UIView?, font:CGFloat,placheholder:String?, isPassWord:Bool, borderStyle:UITextBorderStyle?, keyboardType:UIKeyboardType? ) {
        ...
        if leftText != nil { //左边文字
            let leftLabel = UILabel.createLabel(frame: CGRect(x:0, y:0, width:font*CGFloat(leftText!.length), height:frame.size.height), text: leftText!, textColor: leftTextColor!, font: font-2)
            ...
            let leftImageView = UIImageView.createImageView(frame: CGRect(x:0, y:0, width:50, height:frame.size.height), imageName: leftImageName!)
            self.leftView = leftImageView
            self.leftViewMode = UITextFieldViewMode.always
        }
        
        if rightText != nil { //有边文字
            let rightLabel = UILabel.createLabel(frame: CGRect(x:0, y:0, width:font*CGFloat(rightText!.length), height:frame.size.height), text: rightText!, textColor: rightTextColor!, font: font-2)
            ...
            let rightImageView = UIImageView.createImageView(frame: CGRect(x:0, y:0, width:50, height:frame.size.height), imageName: rightImageName!)
