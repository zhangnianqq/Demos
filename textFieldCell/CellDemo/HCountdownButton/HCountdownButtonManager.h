...
@class HCountdownTask;
NS_ASSUME_NONNULL_BEGIN
@interface HCountdownButtonManager : NSObject
 ...
 */
- (BOOL)countdownTaskExistWithKey:(NSString *)akey task:(HCountdownTask * _Nullable * _Nullable)task;
